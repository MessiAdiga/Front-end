...
export const Navbar = () => {
  ...
  return (
    <div>
      <div className="text-center font-sans bg-gray-200 hover:text-red-500">
        <h1>FLASH SALE: 15% OFF EVERYTHING + FREE SHIPPING</h1>
      </div>

      <nav className="flex justify-between p-4 items-center text-center">
        <div>
          <button
        ...
        <div>
          <a href="/" className="font-customBrand text-5xl font-medium">
            sheertex
          </a>
        </div>
